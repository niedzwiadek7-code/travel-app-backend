...
export class Basic1708594151898 implements Seeder {
    ...
    public async run(
        ...
        await dataSource.query(`TRUNCATE TABLE "${process.env.DB_SCHEMA}"."role_entity" RESTART IDENTITY CASCADE`)
        await dataSource.query(`TRUNCATE TABLE "${process.env.DB_SCHEMA}"."activity_type_entity" RESTART IDENTITY CASCADE`)
        await dataSource.query(`TRUNCATE TABLE "${process.env.DB_SCHEMA}"."activity_type_parameter_entity" RESTART IDENTITY CASCADE`)
